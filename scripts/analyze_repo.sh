...
opps  = generate_maintenance_opportunities(snap, rep, const, top_n=1000)
...
(out/'opportunities.json').write_text(json.dumps(opps, indent=2))
...
print('opportunities   :', len(opps))
print('summary         :', rep['forecast']['summary'])
" < /dev/null )
