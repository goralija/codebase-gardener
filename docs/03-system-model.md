...
- Billing add-on state does not block hosted workers from creating GitHub maintenance PRs; repository autonomy mode, Repository Constitution rules, confidence, protected paths, and implemented-fix support remain the PR creation gates.
