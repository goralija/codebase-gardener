...
- Owner: manages billing, installations, organization settings, and all repositories.
- Admin: configures repositories, schedules, autonomy policies, and integrations.
